package com.reihan.recipeapp.adapter
...
import com.reihan.recipeapp.databinding.RowItemRecipeBinding
import com.reihan.recipeapp.ui.DetailActivity

class RecipesAdapter (val listRecipes: ArrayList<Recipes>):
    RecyclerView.Adapter<RecipesAdapter.MyViewHolder>() {
    class MyViewHolder(val binding: RowItemRecipeBinding):
